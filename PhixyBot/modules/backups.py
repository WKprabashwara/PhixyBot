...
import PhixyBot.modules.sql.notes_sql as sql
from PhixyBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from PhixyBot.__main__ import DATA_IMPORT
from PhixyBot.modules.helper_funcs.chat_status import user_admin
from PhixyBot.modules.helper_funcs.alternate import typing_action

# from PhixyBot.modules.rules import get_rules
import PhixyBot.modules.sql.rules_sql as rulessql

# from PhixyBot.modules.sql import warns_sql as warnssql
import PhixyBot.modules.sql.blacklist_sql as blacklistsql
from PhixyBot.modules.sql import disable_sql as disabledsql

# from PhixyBot.modules.sql import cust_filters_sql as filtersql
# import PhixyBot.modules.sql.welcome_sql as welcsql
import PhixyBot.modules.sql.locks_sql as locksql
from PhixyBot.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("PhixyBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("PhixyBot{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Phixy-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("PhixyBot{}.backup".format(chat_id))  # Cleaning file
