...
from PhixyBot.__main__ import STATS, TOKEN, USER_INFO
import PhixyBot.modules.sql.userinfo_sql as sql
from PhixyBot.modules.disable import DisableAbleCommandHandler
from PhixyBot.modules.sql.global_bans_sql import is_user_gbanned
from PhixyBot.modules.sql.afk_sql import is_afk, check_afk_status
from PhixyBot.modules.sql.users_sql import get_user_num_chats
from PhixyBot.modules.helper_funcs.chat_status import sudo_plus
from PhixyBot.modules.helper_funcs.extraction import extract_user
from PhixyBot import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    text = (
        f"<b><i><u>- Appraisal results -</u></i></b> 」\n\n"
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>📊 Phixy's Current stats:</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
